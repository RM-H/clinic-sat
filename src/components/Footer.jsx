            ...
            <Grid container className='clrthree pad' component={'footer'} sx={{minHeight: '15rem', pt: 4}}>
                    ...
                    <List sx={{mt: 2}}>
                        <ListItem disablePadding>
                            <ListItemButton>
                                ...
                                <ListItemText sx={{textAlign: 'right'}}
                                              primary={<a style={{color: 'inherit', textDecoration: 'none'}}
                        ...
                        <ListItem disablePadding>
                            <ListItemButton>
                                ...
                                <ListItemText sx={{textAlign: 'right'}}
                                              primary={<span className='yekan-regular'>{data.address}</span>}/>
                            </ListItemButton>
                        </ListItem>
                        <ListItem disablePadding>
                            <ListItemButton>
                                ...
                                <ListItemText sx={{textAlign: 'right'}}
                                              primary={<a style={{color: 'inherit', textDecoration: 'none'}}
                                                          href={`tel:${data.phone}`}>{data.instagram}</a>}/>
                            </ListItemButton>
                        </ListItem>
                    </List>
                </Grid>
                    ...
                    <List sx={{mt: 2}}>
                        <Link to={'/contact/'} style={{color:'inherit' , textDecoration:'none' }} >
                            <ListItem disablePadding>
                                ...
                                <ListItemButton>
                                    <ListItemText sx={{textAlign: 'right'}}  primary={<span className='yekan-regular'> درباره کلینیک ستارزاده</span>}/>
                                </ListItemButton>
                            </ListItem>
                        </Link>
                        ...
                        <ListItem disablePadding>
                            <ListItemButton  >
                                <ListItemText sx={{textAlign: 'right'}} primary={<span className='yekan-regular'>  بلاگ </span>}/>
                            </ListItemButton>
                        </ListItem>
                        </Link>
                    </List>
                ...
                <Grid xs={12} sx={{p: 2}}>
                    ...
                    <Typography className='yekan' component='p'>
                        ...
                        طراحی و توسعه توسط
                        {' '}
                        <a href="https://ofoghiranian.com/" rel='nofollow' target='_blank'
